...
[silver]#demo > src > main > kotlin > demo > personForm#
...
[silver]#common > src > main > kotlin > ui > theme > FormColors.kt#
...
(siehe: [silver]#demo > src > main > kotlin > demo > personForm > PersonModel#)
